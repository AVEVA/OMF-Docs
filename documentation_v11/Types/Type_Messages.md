...
Types are defined using the JSON Schema specification (http://json-schema.org/). For details on supported property data types and formats, see [Type Properties and Formats](xref:typePropertiesAndFormatsv11).
...
### Examples of Type Messages and Property Formats
   ...
   - [Type Message Example](xref:typeExamplev11)
